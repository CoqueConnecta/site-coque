        ...
        <header>
            ...
            >
                ...
                <div
                    ...
                    `}
                >
                    <a href="#who-we-are" className="btn-secundary h-10 flex items-center justify-center mb-2 md:mb-0 md:mx-2 focus:outline-none focus:ring-2 focus:ring-blue-500" tabIndex={0} role="button">
                        Quem somos
                    </a>
                    <a href="#projects" className="btn-secundary h-10 flex items-center justify-center mb-2 md:mb-0 md:mx-2 focus:outline-none focus:ring-2 focus:ring-blue-500" tabIndex={0} role="button">
                        Nossos Projetos
                    </a>
                    <a href="#contacts" className="btn-secundary h-10 flex items-center justify-center mb-2 md:mb-0 md:mx-2 focus:outline-none focus:ring-2 focus:ring-blue-500" tabIndex={0} role="button">
                        Contatos
                    </a>
                    <a href="#want-help" className="btn-primary h-10 flex items-center justify-center md:ml-auto focus:outline-none focus:ring-2 focus:ring-blue-500" tabIndex={0} role="button">
                        Quero ajudar
                    </a>
                </div>
            </nav>
