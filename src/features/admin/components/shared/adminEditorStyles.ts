...
export const adminDangerButtonClass = 'rounded-xl bg-[var(--admin-danger-bg)] px-3 py-2 text-xs font-semibold text-[var(--admin-danger-text)] transition hover:bg-[var(--admin-danger-bg-hover)]';
